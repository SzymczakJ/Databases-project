...
-- dodanie dania do menu SPRAWDZONE
...
-- dodanie nowego menu SPRAWDZONE
...
-- dodawanie nowego ordera CHYBA GIT
...
-- dodanie dan do nowego zamówienia CHYBA GIT
...
-- dodanie nowej rezerwacji CHYBA GIT
...
BEGIN
    ...
    SET @reservationDate = (SELECT reservationDate FROM Reservations WHERE @reservationId = reservationId)
    IF (EXISTS(SELECT *
...
-- pokazuje wolne stoliki o danym czasie ...
...
-- zamiana zamówienia z nieop³aconego na op³acone
			...
			BEGIN TRANSACTION Tran2
				BEGIN TRY
					...
					SET firstName = @firstName,
						...
						address = @address,
						city = @city,
						postalCode = @postalCode WHERE customerId = @customerId
			...
			BEGIN TRANSACTION Tran2
				BEGIN TRY
					...
					SET firstName = @firstName,
						...
						reportsTo = @reportsTo WHERE @employeeId = employeeId
